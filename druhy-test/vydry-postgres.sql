-- Vydry varianta pro postgresql

\set AUTOCOMMIT off

drop table if exists vydra cascade;
drop table if exists revir cascade;
...
insert into vydra values (13,'Merylin',10,9, to_date('6.7.01','DD.MM.RR'),'H','Z',1);
